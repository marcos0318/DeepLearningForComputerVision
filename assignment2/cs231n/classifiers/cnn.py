...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout2, grads['W3'], grads['b3'] = affine_backward(dout1, cache3)
        dout3, grads['W2'], grads['b2'] = affine_relu_backward(dout2, cache2)
        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout3, cache1)

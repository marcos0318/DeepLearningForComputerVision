...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    z2 = a1.dot(W2) + b2
    z2_shifted = np.exp(z2 - np.max(z2, axis=1).reshape([-1, 1]))
    a2 = z2_shifted / np.sum(z2_shifted, axis=1).reshape([-1, 1])
    scores = z2
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
    ...
    # classifier loss.                                                          #
    #############################################################################
    loss += np.mean(-np.log(a2[np.arange(y.shape[0]), y]))
    ...
    #############################################################################
    dscores = a2
    dscores[range(y.shape[0]), list(y)] -= 1
    dscores /= y.shape[0]
